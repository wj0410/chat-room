...
public class ChatRoomUI {
    ...
    public javax.swing.JTextPane getRecvPane() {
        return recvPane;
    }

    public javax.swing.JTextPane getSendPane() {
        return sendPane;
    }

    public JFrame getChatJFrame() {
        return chatJFrame;
    }
    ...
    private void chatJFrameWindowGainedFocus(WindowEvent e) {
        // 系统托盘图标清空未读
        TrayUtil.noticeTray(false, ClientHolder.clientInfo.getAccount());
    }

    private void chatJFrameWindowLostFocus(WindowEvent e) {
        // 避免一直处在窗口最前方
        this.chatJFrame.setAlwaysOnTop(false);
    }
